...
6. use durable handoffs and `upgrade` later when you want to refresh the baseline
...
- `pre-work` captures the structured repo summary an agent or contributor
  should read before substantial work
