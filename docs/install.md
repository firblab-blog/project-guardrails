...
For this phase, the recommended public install path for Rust users is:
...
Use the archive path below when you do not want Cargo on the target machine or
when you want to install from the exact published release asset set.
